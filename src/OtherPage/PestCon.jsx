        ...
        <div>
            ...
            <div className='mx-auto max-w-screen-lg mt-16'>
                <Swiper
                    ...
                    className="mySwiper"
                >
                    <SwiperSlide><img src="https://i.ibb.co/wcB70mD/pestcon1.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/mhhtbk9/pestcon2.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/8M8tPhY/pestcon3.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/Fxk0F4n/pestcon4.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/Dk3nKsM/pestcon5.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/m4g7hVt/pestcon6.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/dgMssRY/pestcon7.jpg" alt="" /></SwiperSlide>
                    <SwiperSlide><img src="https://i.ibb.co/Y32768m/pestcon8.jpg" alt="" /></SwiperSlide>
                </Swiper>
            </div>
            <div className='flex justify-center gap-10 my-16'>
                <a href="https://guardiant-pest-control.web.app/" target='_blank' className='bg-[#D26E3C] text-white font-semibold text-xl py-2 px-5 rounded-lg hover:text-[#D26E3C] hover:bg-white '>Live Demo</a>
                <a href="https://github.com/masum9100/Pest-Control-Site" target='_blank' className='bg-[#D26E3C] text-white font-semibold text-xl py-2 px-5 rounded-lg hover:text-[#D26E3C] hover:bg-white '>GitHub Repo</a>
            </div>
