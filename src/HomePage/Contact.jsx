                ...
                <div className='lg:w-1/2 space-y-5 lg:space-y-10'>
                    <form className='space-y-5'>
                        <div>
                            ...
                            <input type="text" name="" id="" placeholder='Megan Fox' className='w-full border-b-2 rounded-xl border-[#D26E3C] py-3 px-3'/>
                        </div>
                        <div>
                            <p className='text-xl font-bold mb-2'>Email</p>
                            <input type="email" name="" id="" placeholder='hello@gmail.com' className='w-full border-b-2 rounded-xl border-[#D26E3C] py-3 px-3'/>
                        </div>
                        <div>
                            <p className='text-xl font-bold mb-2'>Phone</p>
                            <input type="tel" name="" id="" placeholder='+880 1234 567 890' className='w-full border-b-2 rounded-xl border-[#D26E3C] py-3 px-3'/>
                        </div>
                        <div>
                            <p className='text-xl font-bold mb-2'>Message</p>
                            <input type="text" name="" id="" placeholder='Hello!' className='w-full border-b-2 rounded-xl border-[#D26E3C] py-3 px-3'/>
                        </div>
                        <div>
